...
// Copia de `scripts/sesion-firebase.js`. Este archivo se pega entero en la
// consola, así que no puede importar nada: si tocas una, toca la otra.
//
...
// 3. El projectId sí está dentro del token: es el `aud` del JWT.
